...
class TicTacToe extends JFrame {
    ...
    final int START_POSITION_X = 600;
    final int START_POSITION_Y = 250;
    final int WINDOW_SIZE = 420;
    final int WINDOW_DX = 12;
    ...
    TicTacToe() {
        ...
        setBounds(START_POSITION_X, START_POSITION_Y, WINDOW_SIZE + 
		    WINDOW_DX, WINDOW_SIZE + WINDOW_DY);
